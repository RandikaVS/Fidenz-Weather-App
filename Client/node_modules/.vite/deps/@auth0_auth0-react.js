  ...
  var d2 = (function() {
    ...
    return e3.prototype.acquireLock = function(t2, o3) {
      return void 0 === o3 && (o3 = 5e3), n2(this, void 0, void 0, (function() {
        var n3, i2, s3, d3, l2, p2, m2;
        return r2(this, (function(r3) {
          switch (r3.label) {
            case 0:
              n3 = Date.now() + h2(4), i2 = Date.now() + o3, s3 = a2 + "-" + t2, d3 = void 0 === this.storageHandler ? c2 : this.storageHandler, r3.label = 1;
            case 1:
              return Date.now() < i2 ? [4, u2(30)] : [3, 8];
            case 2:
              return r3.sent(), null !== d3.getItemSync(s3) ? [3, 5] : (l2 = this.id + "-" + t2 + "-" + n3, [4, u2(Math.floor(25 * Math.random()))]);
            case 3:
              return r3.sent(), d3.setItemSync(s3, JSON.stringify({ id: this.id, iat: n3, timeoutKey: l2, timeAcquired: Date.now(), timeRefreshed: Date.now() })), [4, u2(30)];
            case 4:
              return r3.sent(), null !== (p2 = d3.getItemSync(s3)) && (m2 = JSON.parse(p2)).id === this.id && m2.iat === n3 ? (this.acquiredIatSet.add(n3), this.refreshLockWhileAcquired(s3, n3), [2, true]) : [3, 7];
            case 5:
              return e3.lockCorrector(void 0 === this.storageHandler ? c2 : this.storageHandler), [4, this.waitForSomethingToChange(i2)];
            case 6:
              r3.sent(), r3.label = 7;
            case 7:
              return n3 = Date.now() + h2(4), [3, 1];
            case 8:
              return [2, false];
          }
        }));
      ...
      for (var c3 = false, u3 = 0; u3 < i2.length; u3++) {
        var h3 = i2[u3];
        if (h3.includes(a2)) {
          var d3 = n3.getItemSync(h3);
          if (null !== d3) {
            var l2 = JSON.parse(d3);
            (void 0 === l2.timeRefreshed && l2.timeAcquired < o3 || void 0 !== l2.timeRefreshed && l2.timeRefreshed < o3) && (n3.removeItemSync(h3), c3 = true);
          }
        }
      }
      c3 && e3.notifyWaiters();
...
var a = { name: "auth0-spa-js", version: "2.5.0" };
var c = () => Date.now();
...
var h = class _h extends u {
  constructor(e2, t2, o2, n2 = null) {
    super(e2, t2), this.state = o2, this.appState = n2, Object.setPrototypeOf(this, _h.prototype);
  }
};
...
var m = class _m extends u {
  constructor(e2, t2, o2) {
    super(e2, t2), this.mfa_token = o2, Object.setPrototypeOf(this, _m.prototype);
  }
};
var f = class _f extends u {
  constructor(e2, t2) {
    super("missing_refresh_token", `Missing Refresh Token (audience: '${y(e2, ["default"])}', scope: '${y(t2)}')`), this.audience = e2, this.scope = t2, Object.setPrototypeOf(this, _f.prototype);
  }
};
...
var b = () => {
  ...
  let t2 = "";
  return Array.from(w().getRandomValues(new Uint8Array(43))).forEach(((o2) => t2 += e2[o2 % e2.length])), t2;
};
var k = (e2) => btoa(e2);
var v = (t2) => {
...
async function O(e2, t2, o2) {
  ...
  const n2 = `${x(T(JSON.stringify(e2)))}.${x(T(JSON.stringify(t2)))}`;
  return `${n2}.${x(await crypto.subtle.sign((function(e3) {
    switch (e3.algorithm.name) {
      case "ECDSA":
        return { name: e3.algorithm.name, hash: "SHA-256" };
      case "RSA-PSS":
        return P(e3.algorithm), { name: e3.algorithm.name, saltLength: 32 };
      case "RSASSA-PKCS1-v1_5":
        return P(e3.algorithm), { name: e3.algorithm.name };
      case "Ed25519":
...
var j;
if (Uint8Array.prototype.toBase64) j = (e2) => (e2 instanceof ArrayBuffer && (e2 = new Uint8Array(e2)), e2.toBase64({ alphabet: "base64url", omitPadding: true }));
else {
  const e2 = 32768;
  j = (t2) => {
...
async function D(e2, t2, o2, n2, i2, r2) {
  ...
  var c2;
  if (!N(a2)) throw new TypeError('"keypair.publicKey" must be a public CryptoKey');
  ...
  return O({ alg: E(s2), typ: "dpop+jwt", jwk: await Z(a2) }, Object.assign(Object.assign({}, r2), { iat: Math.floor(Date.now() / 1e3), jti: crypto.randomUUID(), htm: o2, nonce: n2, htu: t2, ath: i2 ? x(await crypto.subtle.digest("SHA-256", T(i2))) : void 0 }), s2);
}
async function Z(e2) {
  const { kty: t2, e: o2, n: n2, x: i2, y: r2, crv: s2 } = await crypto.subtle.exportKey("jwk", e2);
  return { kty: t2, crv: s2, e: o2, n: n2, x: i2, y: r2 };
}
var R = ["authorization_code", "refresh_token", "urn:ietf:params:oauth:grant-type:token-exchange"];
function U() {
...
function L(e2) {
  return (async function(e3) {
    if (!N(e3)) throw new TypeError('"publicKey" must be a public CryptoKey');
    ...
    return x(await crypto.subtle.digest({ name: "SHA-256" }, T(JSON.stringify(o2))));
  })(e2.publicKey);
}
function W({ keyPair: e2, url: t2, method: o2, nonce: n2, accessToken: i2 }) {
  const r2 = (function(e3) {
    const t3 = new URL(e3);
    return t3.search = "", t3.hash = "", t3.href;
  })(t2);
  return D(e2, r2, o2, n2, i2);
}
var H = async (e2, t2) => {
...
var A = async (e2, t2, o2) => {
  const n2 = new AbortController();
  let i2;
  return t2.signal = n2.signal, Promise.race([H(e2, t2), new Promise(((e3, t3) => {
    i2 = setTimeout((() => {
...
var J = async (e2, t2, o2, n2, i2, r2, s2, a2) => {
...
var X = async (e2, t2, o2, n2, i2, r2, s2 = 1e4, a2) => i2 ? J(e2, t2, o2, n2, s2, i2, r2, a2) : A(e2, n2, s2);
async function V(t2, o2, n2, i2, r2, s2, a2, c2, h2, d2) {
  if (h2) {
    const e2 = await h2.generateProof({ url: t2, method: r2.method || "GET", nonce: await h2.getNonce() });
    r2.headers = Object.assign(Object.assign({}, r2.headers), { dpop: e2 });
  }
  let l2, p2 = null;
  for (let e2 = 0; e2 < 3; e2++) try {
    l2 = await X(t2, n2, i2, r2, s2, a2, o2, c2), p2 = null;
    break;
  } catch (e3) {
    p2 = e3;
  }
  if (p2) throw p2;
  const y2 = l2.json, { error: w2, error_description: b2 } = y2, k2 = e(y2, ["error", "error_description"]), { headers: v2, ok: _2 } = l2;
  let I2;
  if (h2 && (I2 = v2["dpop-nonce"], I2 && await h2.setNonce(I2)), !_2) {
    const e2 = b2 || `HTTP error. Unable to fetch ${t2}`;
    if ("mfa_required" === w2) throw new m(w2, e2, k2.mfa_token);
    if ("missing_refresh_token" === w2) throw new f(n2, i2);
    if ("use_dpop_nonce" === w2) {
      if (!h2 || !I2 || d2) throw new g(I2);
      return V(t2, o2, n2, i2, r2, s2, a2, c2, h2, true);
    }
    throw new u(w2 || "request_error", e2);
  }
  return k2;
}
async function G(t2, o2) {
  var { baseUrl: n2, timeout: i2, audience: r2, scope: s2, auth0Client: c2, useFormData: u2, useMrrt: h2, dpop: d2 } = t2, l2 = e(t2, ["baseUrl", "timeout", "audience", "scope", "auth0Client", "useFormData", "useMrrt", "dpop"]);
  const p2 = "urn:ietf:params:oauth:grant-type:token-exchange" === l2.grant_type, m2 = "refresh_token" === l2.grant_type && h2, f2 = Object.assign(Object.assign(Object.assign(Object.assign({}, l2), p2 && r2 && { audience: r2 }), p2 && s2 && { scope: s2 }), m2 && { audience: r2, scope: s2 }), g2 = u2 ? v(f2) : JSON.stringify(f2), y2 = (w2 = l2.grant_type, R.includes(w2));
  var w2;
  return await V(`${n2}/oauth/token`, i2, r2 || "default", s2, { method: "POST", body: g2, headers: { "Content-Type": u2 ? "application/x-www-form-urlencoded" : "application/json", "Auth0-Client": btoa(JSON.stringify(c2 || a)) } }, o2, u2, h2, y2 ? d2 : void 0);
}
var F = (...e2) => {
...
var M = class _M {
  ...
  static fromKey(e2) {
    ...
    return new _M({ clientId: o2, scope: i2, audience: n2 }, t2);
  }
  static fromCacheEntry(e2) {
    const { scope: t2, audience: o2, client_id: n2 } = e2;
    return new _M({ scope: t2, audience: o2, clientId: n2 });
  }
};
var Y = class {
  set(e2, t2) {
...
var B = class {
  ...
  async set(e2) {
    var t2;
    const o2 = new M({ clientId: e2.client_id, scope: e2.scope, audience: e2.audience }), n2 = await this.wrapCacheEntry(e2);
  ...
  matchExistingCacheKey(e2, t2) {
    return t2.filter(((t3) => {
      var o2;
      const n2 = M.fromKey(t3), i2 = new Set(n2.scope && n2.scope.split(" ")), r2 = (null === (o2 = e2.scope) || void 0 === o2 ? void 0 : o2.split(" ")) || [], s2 = n2.scope && r2.reduce(((e3, t4) => e3 && i2.has(t4)), true);
...
var te = (e2) => {
  ...
  const t2 = ((e3) => {
    ...
    const r2 = JSON.parse(_(n3)), s2 = { __raw: e3 }, a2 = {};
    return Object.keys(r2).forEach(((e4) => {
      s2[e4] = r2[e4], ee.includes(e4) || (a2[e4] = r2[e4]);
    })), { encoded: { header: o3, payload: n3, signature: i3 }, header: JSON.parse(_(o3)), claims: s2, user: a2 };
  })(e2.id_token);
...
var se = { get(e2) {
  ...
  let n2 = {};
  "https:" === window.location.protocol && (n2 = { secure: true, sameSite: "none" }), (null == o2 ? void 0 : o2.daysUntilExpire) && (n2.expires = o2.daysUntilExpire), (null == o2 ? void 0 : o2.cookieDomain) && (n2.domain = o2.cookieDomain), ie(e2, JSON.stringify(t2), n2);
}, remove(e2, t2) {
  let o2 = {};
  (null == t2 ? void 0 : t2.cookieDomain) && (o2.domain = t2.cookieDomain), re(e2, o2);
} };
var ae = { get(e2) {
  const t2 = se.get(e2);
  ...
  let n2 = {};
  "https:" === window.location.protocol && (n2 = { secure: true }), (null == o2 ? void 0 : o2.daysUntilExpire) && (n2.expires = o2.daysUntilExpire), (null == o2 ? void 0 : o2.cookieDomain) && (n2.domain = o2.cookieDomain), ie(`_legacy_${e2}`, JSON.stringify(t2), n2), se.save(e2, t2, o2);
}, remove(e2, t2) {
  let o2 = {};
  (null == t2 ? void 0 : t2.cookieDomain) && (o2.domain = t2.cookieDomain), re(e2, o2), se.remove(e2, t2), se.remove(`_legacy_${e2}`, t2);
} };
var ce = { get(e2) {
...
var ye = { memory: () => new $().enclosedCache, localstorage: () => new Y() };
var we = (e2) => ye[e2];
var be = (t2) => {
...
var ve = { NONCE: "nonce", KEYPAIR: "keypair" };
var _e = class {
  constructor(e2) {
    this.clientId = e2;
  }
  ...
  createDbHandle() {
    ...
    return new Promise(((t2, o2) => {
      e2.onupgradeneeded = () => Object.values(ve).forEach(((t3) => e2.result.createObjectStore(t3))), e2.onerror = () => o2(e2.error), e2.onsuccess = () => t2(e2.result);
    }));
  }
  async getDbHandle() {
  ...
  setNonce(e2, t2) {
    return this.save(ve.NONCE, this.buildKey(t2), e2);
  }
  setKeyPair(e2) {
    return this.save(ve.KEYPAIR, this.buildKey(), e2);
  }
  async save(e2, t2, o2) {
    await this.executeDbRequest(e2, "readwrite", ((e3) => e3.put(o2, t2)));
  }
  findNonce(e2) {
    return this.find(ve.NONCE, this.buildKey(e2));
  }
  findKeyPair() {
...
var Ie = class {
  ...
  async getOrGenerateKeyPair() {
    ...
    return e2 || (e2 = await U(), await this.storage.setKeyPair(e2)), e2;
  }
  async generateProof(e2) {
    const t2 = await this.getOrGenerateKeyPair();
    return W(Object.assign({ keyPair: t2 }, e2));
  }
  async calculateThumbprint() {
    return L(await this.getOrGenerateKeyPair());
  }
  async clear() {
...
var Se = class {
  ...
  buildBaseRequest(e2, t2) {
    const o2 = new Request(e2, t2);
    return this.config.baseUrl ? new Request(this.buildUrl(this.config.baseUrl, o2.url), o2) : o2;
  }
  ...
  async prepareRequest(e2, t2) {
    ...
    this.setAuthorizationHeader(e2, o2), await this.setDpopProofHeader(e2, o2);
  }
  getHeader(e2, t2) {
  ...
  async handleResponse(e2, t2) {
    ...
    if (!o2 || !t2.onUseDpopNonceError) throw new g(o2);
...
var Pe = class {
  constructor(e2) {
    ...
    if (this.userCache = new $().enclosedCache, this.defaultOptions = { authorizationParams: { scope: "openid profile email" }, useRefreshTokensFallback: false, useFormData: true }, this._releaseLockOnPageHide = async () => {
      await Te.releaseLock("auth0.lock.getTokenSilently"), window.removeEventListener("pagehide", this._releaseLockOnPageHide);
      ...
      if (t2 = e2.cacheLocation || "memory", !we(t2)) throw new Error(`Invalid cache location "${t2}"`);
      o2 = we(t2)();
    }
  ...
  async _verifyIdToken(e2, t2, o2) {
    ...
    return te({ iss: this.tokenIssuer, aud: this.options.clientId, id_token: e2, nonce: t2, organization: o2, leeway: this.options.leeway, max_age: (i2 = this.options.authorizationParams.max_age, "string" != typeof i2 ? i2 : parseInt(i2, 10) || void 0), now: n2 });
    var i2;
  }
  _processOrgHint(e2) {
  ...
  async _prepareAuthorizeUrl(e2, t2, o2) {
    ...
    const i2 = k(b()), r2 = k(b()), s2 = b(), a2 = ((e3) => {
      ...
      return await t3;
    })(s2)), c2 = await (null === (n2 = this.dpop) || void 0 === n2 ? void 0 : n2.calculateThumbprint()), u2 = ((e3, t3, o3, n3, i3, r3, s3, a3, c3) => Object.assign(Object.assign(Object.assign({ client_id: e3.clientId }, e3.authorizationParams), o3), { scope: F(t3, o3.scope), response_type: "code", response_mode: a3 || "query", state: n3, nonce: i3, redirect_uri: s3 || e3.authorizationParams.redirect_uri, code_challenge: r3, code_challenge_method: "S256", dpop_jkt: c3 }))(this.options, this.scope, e2, i2, r2, a2, e2.redirect_uri || this.options.authorizationParams.redirect_uri || o2, null == t2 ? void 0 : t2.response_mode, c2), h2 = this._authorizeUrl(u2);
  ...
  async loginWithPopup(e2, t2) {
    ...
    const i2 = await ((e3) => new Promise(((t3, o3) => {
      ...
      const i3 = setInterval((() => {
        e3.popup && e3.popup.closed && (clearInterval(i3), clearTimeout(r3), window.removeEventListener("message", n3, false), o3(new p(e3.popup)));
      }), 1e3), r3 = setTimeout((() => {
        clearInterval(i3), o3(new l(e3.popup)), window.removeEventListener("message", n3, false);
  ...
  async loginWithRedirect(t2 = {}) {
    var o2;
    const n2 = be(t2), { openUrl: i2, fragment: r2, appState: s2 } = n2, a2 = e(n2, ["openUrl", "fragment", "appState"]), c2 = (null === (o2 = a2.authorizationParams) || void 0 === o2 ? void 0 : o2.organization) || this.options.authorizationParams.organization, u2 = await this._prepareAuthorizeUrl(a2.authorizationParams || {}), { url: h2 } = u2, d2 = e(u2, ["url"]);
  ...
  async handleRedirectCallback(e2 = window.location.href) {
    ...
    const { state: o2, code: n2, error: i2, error_description: r2 } = ((e3) => {
    ...
    if (this.transactionManager.remove(), i2) throw new h(i2, r2 || i2, o2, s2.appState);
    if (!s2.code_verifier || s2.state && s2.state !== o2) throw new u("state_mismatch", "Invalid state");
    const a2 = s2.organization, c2 = s2.nonce, d2 = s2.redirect_uri;
    return await this._requestToken(Object.assign({ audience: s2.audience, scope: s2.scope, code_verifier: s2.code_verifier, grant_type: "authorization_code", code: n2 }, d2 ? { redirect_uri: d2 } : {}), { nonceIn: c2, organization: a2 }), { appState: s2.appState };
  }
  ...
  async getTokenSilently(e2 = {}) {
    var t2;
    const o2 = Object.assign(Object.assign({ cacheMode: "on" }, e2), { authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e2.authorizationParams), { scope: F(this.scope, null === (t2 = e2.authorizationParams) || void 0 === t2 ? void 0 : t2.scope) }) }), n2 = await ((e3, t3) => {
      let o3 = fe[t3];
      return o3 || (o3 = e3().finally((() => {
        delete fe[t3], o3 = null;
      })), fe[t3] = o3), o3;
    })((() => this._getTokenSilently(o2)), `${this.options.clientId}::${o2.authorizationParams.audience}::${o2.authorizationParams.scope}`);
    return e2.detailedResponse ? n2 : null == n2 ? void 0 : n2.access_token;
  }
  async _getTokenSilently(t2) {
    ...
    if ("cache-only" !== o2) {
      ...
      try {
        if (window.addEventListener("pagehide", this._releaseLockOnPageHide), "off" !== o2) {
        ...
        const e2 = this.options.useRefreshTokens ? await this._getTokenUsingRefreshToken(n2) : await this._getTokenFromIFrame(n2), { id_token: t3, token_type: i2, access_token: r2, oauthTokenScope: s2, expires_in: a2 } = e2;
  ...
  async getTokenWithPopup(e2 = {}, t2 = {}) {
    var o2;
    const n2 = Object.assign(Object.assign({}, e2), { authorizationParams: Object.assign(Object.assign(Object.assign({}, this.options.authorizationParams), e2.authorizationParams), { scope: F(this.scope, null === (o2 = e2.authorizationParams) || void 0 === o2 ? void 0 : o2.scope) }) });
    t2 = Object.assign(Object.assign({}, s), t2), await this.loginWithPopup(n2, t2);
    return (await this.cacheManager.get(new M({ scope: n2.authorizationParams.scope, audience: n2.authorizationParams.audience || "default", clientId: this.options.clientId }), void 0, this.options.useMrrt)).access_token;
  }
  ...
  async logout(t2 = {}) {
    var o2;
    const n2 = be(t2), { openUrl: i2 } = n2, r2 = e(n2, ["openUrl"]);
  ...
  async _getTokenFromIFrame(e2) {
    ...
    const { url: n2, state: i2, nonce: r2, code_verifier: s2, redirect_uri: a2, scope: c2, audience: h2 } = await this._prepareAuthorizeUrl(t2, { response_mode: "web_message" }, window.location.origin);
    try {
  ...
  async _getTokenUsingRefreshToken(e2) {
    const t2 = await this.cacheManager.get(new M({ scope: e2.authorizationParams.scope, audience: e2.authorizationParams.audience || "default", clientId: this.options.clientId }), void 0, this.options.useMrrt);
  ...
  async _getIdTokenFromCache() {
    const e2 = this.options.authorizationParams.audience || "default", t2 = await this.cacheManager.getIdToken(new M({ clientId: this.options.clientId, audience: e2, scope: this.scope })), o2 = this.userCache.get("@@user@@");
    return t2 && t2.id_token === (null == o2 ? void 0 : o2.id_token) ? o2 : (this.userCache.set("@@user@@", t2), t2);
  }
  async _getEntryFromCache({ scope: e2, audience: t2, clientId: o2, cacheMode: n2 }) {
    const i2 = await this.cacheManager.get(new M({ scope: e2, audience: t2, clientId: o2 }), 60, this.options.useMrrt, n2);
  ...
  async exchangeToken(e2) {
    return this._requestToken({ grant_type: "urn:ietf:params:oauth:grant-type:token-exchange", subject_token: e2.subject_token, subject_token_type: e2.subject_token_type, scope: F(e2.scope, this.scope), audience: e2.audience || this.options.authorizationParams.audience });
  }
  _assertDpop(e2) {
  ...
  createFetcher(e2 = {}) {
    ...
    return new Se(e2, { isDpopEnabled: () => !!this.options.useDpop, getAccessToken: (e3) => {
      var t2;
      return this.getTokenSilently({ authorizationParams: { scope: null === (t2 = null == e3 ? void 0 : e3.scope) || void 0 === t2 ? void 0 : t2.join(" "), audience: null == e3 ? void 0 : e3.audience } });
    }, getDpopNonce: () => this.getDpopNonce(e2.dpopNonceId), setDpopNonce: (e3) => this.setDpopNonce(e3), generateDpopProof: (e3) => this.generateDpopProof(e3) });
  }
};
var Oe = class {
};
...
var Auth0Provider = function(opts) {
  ...
  var client = (0, import_react.useState)(function() {
    return new Pe(toAuth0ClientOptions(clientOpts));
  })[0];
